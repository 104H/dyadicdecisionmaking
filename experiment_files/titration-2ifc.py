...
def geninstrfamiliarization():
    ...
    When you hear the beep, press the green button for the first interval and the red button for the second interval.\n\n\
...
def geninstrtitration():
    ...
    Press the green button if the stripes were in the first interval and the red button if there were stripes in the second interval. \n\
